...
-- insert into city(country, name, state, map) values ('USA', 'Chicago', 'IL', '41.878114, -87.629798');
insert into city(id, country, name, state, map) values (2, 'Australia', 'Brisbane', 'Queensland', '-27.470933, 153.023502');
insert into city(id, country, name, state, map) values (3, 'Australia', 'Melbourne', 'Victoria', '-37.813187, 144.96298');
insert into city(id, country, name, state, map) values (4, 'Australia', 'Sydney', 'New South Wales', '-33.868901, 151.207091');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Canada', 'Montreal', 'Quebec', '45.508889, -73.554167');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Israel', 'Tel Aviv', '', '32.066157, 34.777821');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Japan', 'Tokyo', '', '35.689488, 139.691706');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Spain', 'Barcelona', 'Catalunya', '41.387917, 2.169919');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Switzerland', 'Neuchatel', '', '46.992979, 6.931933');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'UK', 'Bath', 'Somerset', '51.381428, -2.357454');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'UK', 'London', '', '51.500152, -0.126236');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'UK', 'Southampton', 'Hampshire', '50.902571, -1.397238');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'USA', 'Atlanta', 'GA', '33.748995, -84.387982');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'USA', 'Chicago', 'IL', '41.878114, -87.629798');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'USA', 'Chicago', 'IL', '41.878114, -87.629798');

insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Australia', 'Brisbane', 'Queensland', '-27.470933, 153.023502');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Australia', 'Melbourne', 'Victoria', '-37.813187, 144.96298');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Australia', 'Sydney', 'New South Wales', '-33.868901, 151.207091');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Canada', 'Montreal', 'Quebec', '45.508889, -73.554167');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Israel', 'Tel Aviv', '', '32.066157, 34.777821');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Japan', 'Tokyo', '', '35.689488, 139.691706');
insert into city(id, country, name, state, map) values (CITY_SEQ.nextval, 'Spain', 'Barcelona', 'Catalunya', '41.387917, 2.169919');
...
insert into hotel(id, city_id, name, address, zip) values (3, 3, 'The Langham', '1 Southgate Ave, Southbank', '3006');
insert into hotel(id, city_id, name, address, zip) values (4, 4, 'The Langham', '1 Southgate Ave, Southbank', '3006');
insert into review(id, hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 0, '2005-05-10', 2, 4, 'Pretty average', 'I stayed in 2005, the hotel was nice enough but nothing special.');
insert into review(id,hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 1, '2006-01-12', 4, 2, 'Bright hotel with big rooms', 'This hotel has a fantastic lovely big windows.  The room we stayed in had lots of space.  Recommended.');
insert into review(id,hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 1, '2006-01-12', 4, 2, 'Bright hotel with big rooms', 'This hotel has a fantastic lovely big windows.  The room we stayed in had lots of space.  Recommended.');
insert into review(id,hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 1, '2006-01-12', 4, 2, 'Bright hotel with big rooms', 'This hotel has a fantastic lovely big windows.  The room we stayed in had lots of space.  Recommended.');
insert into review(id,hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 1, '2006-01-12', 4, 2, 'Bright hotel with big rooms', 'This hotel has a fantastic lovely big windows.  The room we stayed in had lots of space.  Recommended.');
insert into review(id,hotel_id, idx, check_in_date, rating, trip_type, title, details) values (REVIEW_SEQ.nextval, 2, 1, '2006-01-12', 4, 2, 'Bright hotel with big rooms', 'This hotel has a fantastic lovely big windows.  The room we stayed in had lots of space.  Recommended.');
